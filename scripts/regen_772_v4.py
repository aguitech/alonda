#!/usr/bin/env python3
"""Retry image 772 with safer Egyptian goddess prompt - copy of working pattern."""
...
KEY = "minimax" + "-oauth"
TOKEN=auth.g...rs", {}).get("minimax" + "-oauth", {}).get("access_token") or (_pool.get("minimax" + "-oauth") or [{}])[0].get("access_token")
if not TOKEN:
...
Path("/root/alonda/scripts/regen_772_v4_results.json").write_text(json.dumps(results, indent=2))
