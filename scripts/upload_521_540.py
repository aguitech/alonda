#!/usr/bin/env python3
"""Upload batch 521-540 to tmpfiles.org (fallback file.io)."""
...
files = sorted([f for f in OUT_DIR.glob("5[23][0-9]_*.jpg") if f.name.startswith(("52", "53", "54"))])
files = [f for f in files if f.name[:3] in ("521","522","523","524","525","526","527","528","529","530","531","532","533","534","535","536","537","538","539","540")]
...
Path("/root/alonda/scripts/batch_521_540_uploads.json").write_text(json.dumps(results, indent=2, ensure_ascii=False))
