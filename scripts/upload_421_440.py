#!/usr/bin/env python3
"""Upload batch 421-440 — uguu.se primary, litterbox (catbox 1h) fallback."""
...
files = sorted([p for p in OUT.glob("4*.jpg") if 421 <= int(p.stem.split("_")[0]) <= 440])
...
out = Path("/root/alonda/scripts/batch_421_440_uploads.json")
