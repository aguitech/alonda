...
PROMPTS = [
    ALONDA + "as a Fijian fire walker in a vivid Pacific island village ceremony stepping barefoot across glowing red-hot lava stones at night, vivid orange flames, vivid emerald and vermilion tropical frangipani lei, vivid palms swaying, dramatic fire ritual portrait, ultra detailed"
]
...
Path("/root/alonda/scripts/regen_688.json").write_text(json.dumps(results, indent=2))
