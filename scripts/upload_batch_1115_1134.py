#!/usr/bin/env python3
"""Upload Alonda portraits 1115-1134 to tmpfiles.org (curl-based)."""
import json
import subprocess
import os
...
with open("/root/alonda/scripts/batch_1115_1134_uploads.json", "w") as f:
    json.dump(results, f, indent=2)
print(f"Saved to batch_1115_1134_uploads.json", flush=True)
