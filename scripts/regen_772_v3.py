#!/usr/bin/env python3
"""Retry image 772 with safer Egyptian goddess prompt."""
...
if not TOKEN:
    print("FATAL: no token"); sys.exit(2)
...
n = 772
fname = f"{n}_as_the_egyptian_goddess_isis_in_vivid_egyptian_regalia.jpg"
out_path = OUT / fname
...
print("[FAIL] all prompts failed", flush=True); sys.exit(1)
