#!/usr/bin/env python3
"""Upload batch 1015-1034 to litterbox.catbox.moe (72h)."""
import json
import re
import ssl
...
(SCRIPT_DIR / "batch_1015_1034_uploads.json").write_text(json.dumps(uploads, indent=2))
